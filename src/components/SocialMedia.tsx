      ...
      <div className="container-main">
        ...
        <div className="bg-graphite text-graphite-foreground rounded-2xl p-8 md:p-12">
          <div className="text-center mb-8">
            ...
            <p className="opacity-80 font-light">Будьте в курсе новых проектов и полезных советов по строительству</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {channels.map((channel, index) => (
              <a
                ...
                className={`flex items-center gap-4 p-4 bg-background/10 rounded-xl hover:bg-background/20 transition-colors ${channel.comingSoon ? 'pointer-events-none' : ''}`}
              >
