  ...
  const projects = [
    {
      ...
      description: "Премиальный проект частного дома с кинозалом с эргономичными креслами и профессиональным звуковым оборудованием. Реализована система затемнения и акустическая изоляция. Интерьер выполнен в современном минималистичном стиле с использованием тёмных тонов."
    },
    {
      image: portfolio2,
      title: "Гостевой дом в НОЦ «Энергетик»",
      description: "Дом с гостевой спальней с панорамным остеклением и видом на сосновый лес. Использованы натуральные материалы: дерево, камень, текстиль. Продуманное освещение создаёт атмосферу уюта. Минималистичный дизайн подчёркивает связь с природой."
    },
    {
      image: portfolio3,
